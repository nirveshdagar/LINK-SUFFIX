...
describe("guarded storage maintenance", () => {
  ...
  it("keeps the committed unit definitions resource bounded", () => {
    ...
    expect(service).toContain("DOCKER_CONFIG=/var/lib/link-suffix-maintenance/docker");
    expect(service).toContain("BUILDX_CONFIG=/var/lib/link-suffix-maintenance/buildx");
